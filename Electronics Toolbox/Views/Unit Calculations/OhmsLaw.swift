                ...
                if (unknownQuantity == .voltage) {
                    HStack {
                        Text("Voltage:")
                            .bold()
                        Spacer()
                        Text("\(outputVoltage.value, specifier: "%.2f")\(outputVoltage.prefix.description)")
                    }
                    ...
                    HStack {
                        Text("Current:")
                            .bold()
                        Spacer()
                        Text("\(outputCurrent.value, specifier: "%.2f")\(outputCurrent.prefix.description)")
                    }
                } else {
                    HStack {
                        Text("Resistance:")
                            .bold()
                        Spacer()
                        Text("\(outputResistance.value, specifier: "%.2f")\(outputResistance.prefix.description)")
                    }
                }
            }
